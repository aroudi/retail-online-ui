...
export abstract class ResourceService<T> {
  private readonly APIUrl = environment.backend + this.getResourceUrl();
  //private readonly APIUrl = 'http://localhost:8383/retail-online-order/' + this.getResourceUrl();
  ...
  getListPaging(index: number, page: number): Observable<T[]> {
